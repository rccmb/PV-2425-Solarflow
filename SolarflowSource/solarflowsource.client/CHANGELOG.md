...
- Create Angular project with ng: `ng new solarflowsource.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`solarflowsource.client.esproj`).
