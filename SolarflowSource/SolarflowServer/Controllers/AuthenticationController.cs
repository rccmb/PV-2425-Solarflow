        ...
        public async Task<IActionResult> Login([FromBody] LoginDTO model)
        {
            ...
            if (user != null && user.EmailConfirmed == true)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _auditService.LogAsync(user.Id.ToString(), "Authentication", "User Logged In", GetClientIPAddress());
                    return Ok(new { token });
                }
            }
            ...
            await _auditService.LogAsync(viewUser.Id.ToString(), "View Account", "View Account Logged In", GetClientIPAddress());
